      ...
      <Form method="POST">
        ...
        <div className="mb-5 flex flex-col gap-2 sm:flex-row sm:items-center">
          ...
          <div className="grow">
            ...
            {formErrors?.phone && (
              <p className="ml-5 mt-2 rounded-md bg-red-200 p-0.5 pl-4 text-xs text-red-600">
                {formErrors.phone}
              </p>
            )}
          </div>
        ...
        <div className="relative mb-5 flex flex-col gap-2 sm:flex-row sm:items-center">
          ...
          {!position.latitude && !position.longitude && (
            <span className="z-1 absolute right-[3px] top-[34px] sm:top-[3px]">
              <Button
                disabled={isLoadingAddress}
                type="position"
                onClick={(e) => {
...
export async function action({ request }) {
  ...
  if (!isValidPhone(order.phone)) {
    errors.phone = `Please provide your correct phone number. We might need it to contact you.`;
  }
